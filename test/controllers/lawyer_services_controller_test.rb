...
class LawyerServicesControllerTest < ActionController::TestCase
  ...
  test "should create lawyer_service" do
    assert_difference('LawyerService.count') do
      post :create, lawyer_service: { charges: @lawyer_service.charges, code: @lawyer_service.code, service_code: @lawyer_service.service_code, service_name: @lawyer_service.service_name }
    end
  ...
  test "should update lawyer_service" do
    patch :update, id: @lawyer_service, lawyer_service: { charges: @lawyer_service.charges, code: @lawyer_service.code, service_code: @lawyer_service.service_code, service_name: @lawyer_service.service_name }
    assert_redirected_to lawyer_service_path(assigns(:lawyer_service))
  end
